...
# Dna modifying dna
execute unless data block ~ ~ ~ Items[{Slot:3b}].tag.dnd.genome.modified unless data block ~ ~ ~ Items[{Slot:21b}].tag.dnd.genome.modified if block ~ ~ ~ barrel{Items:[{Slot:21b,tag:{dnd:{id:"dna_vial"}}},{Slot:3b,tag:{dnd:{id:"dna_vial"}}}]} run function dnd:block/modifier/recipes/modify_dna
