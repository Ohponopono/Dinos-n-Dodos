...
summon armor_stand ~ ~ ~ {CustomName:'{"translate":"block.dnd.paleontology_table"}',Fire:32767s,ArmorItems:[{},{},{},{id:"minecraft:barrel",Count:1b,tag:{CustomModelData:400000}}],Tags:["dnd.block","dnd.paleontology_table","dnd.entity","global.ignore","dnd.barrel"],NoGravity:1b,Invisible:1b,Marker:1b}
