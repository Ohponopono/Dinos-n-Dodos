...
execute as @a[distance=..12,sort=nearest,tag=dnd.inside_paleontology_table_gui] run function dnd:block/paleontology_table/crafting/output/cursor_check/main
execute unless entity @a[distance=..12,sort=nearest,tag=dnd.inside_paleontology_table_gui,tag=!dnd.shift_clicked] run function dnd:block/paleontology_table/crafting/output/shift_click/main
