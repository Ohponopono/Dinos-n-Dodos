...
# Projector
execute store result score @s dnd.dummy if entity @s[scores={dnd.dummy=0}] if data storage dnd:storage root.temp{crafting_input:{0:[{id:"minecraft:redstone_lamp",Slot:0b},{id:"minecraft:glass",Slot:1b},{id:"minecraft:redstone_lamp",Slot:2b}],1:[{id:"minecraft:quartz_block",Slot:0b},{tag:{dnd:{id:"computer_chip"}},Slot:1b},{id:"minecraft:quartz_block",Slot:2b}],2:[{item_tag:"#minecraft:planks",Slot:0b},{item_tag:"#minecraft:planks",Slot:1b},{item_tag:"#minecraft:planks",Slot:2b}]}} run loot replace block ~ ~ ~ container.16 loot dnd:items/projector
