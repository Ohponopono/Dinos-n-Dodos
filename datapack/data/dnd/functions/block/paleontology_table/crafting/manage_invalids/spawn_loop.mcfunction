...
execute as @p[tag=dnd.inside_paleontology_table_gui,gamemode=!spectator] at @s run summon item ~ ~ ~ {PickupDelay:3s,Item:{id:"stone",Count:1b},Tags:["dnd.replace_item","global.ignore"]}
