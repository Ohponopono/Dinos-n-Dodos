...
execute store result score @s dnd.dummy if entity @s[scores={dnd.dummy=0},tag=dnd.cultivator] unless block ~ ~ ~ barrel{Items:[{Slot:21b}]} run data modify block ~ ~ ~ Items[{Slot:0b,id:"minecraft:milk_bucket"}].Slot set value 21b
