...
particle minecraft:item furnace{CustomModelData:400007} ~ ~ ~ 0.2 0.2 0.2 0.05 50 normal
...
execute positioned ~ ~2 ~ if entity @e[type=wandering_trader,tag=dnd.fossil,distance=...5] run tp @e[type=wandering_trader,tag=dnd.fossil,distance=...5] ~ ~-666 ~
