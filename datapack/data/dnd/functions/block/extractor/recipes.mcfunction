...
execute if data storage dnd:storage root.temp.genome if block ~ ~ ~ barrel{Items:[{Slot:21b,id:"minecraft:glass_bottle"}]} run function dnd:block/extractor/recipes/item_to_dna
# Recipes
