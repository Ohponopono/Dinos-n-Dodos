...
data modify block ~ ~ ~ Items[{Slot:14b}].tag.dnd.storage.genome set from block ~ ~ ~ Items[{Slot:3b}].tag.dnd.storage.genome
data modify block ~ ~ ~ Items[{Slot:14b}].tag.dnd.storage.UniqueData set from block ~ ~ ~ Items[{Slot:3b}].tag.dnd.storage.UniqueData
