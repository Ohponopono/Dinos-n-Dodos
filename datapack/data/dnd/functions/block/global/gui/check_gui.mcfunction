...
## Shift-clicking
execute store success score @s dnd.dummy if entity @s[tag=dnd.genetic_extractor] if data storage dnd:storage root.temp.item[{Slot:0b}].Count unless data storage dnd:storage root.temp.item[{Slot:3b}].Count run item replace block ~ ~ ~ container.3 from block ~ ~ ~ container.0
execute if entity @s[tag=dnd.genetic_extractor,scores={dnd.dummy=1}] run item replace block ~ ~ ~ container.0 with air
...
execute store success score @s dnd.dummy unless entity @s[tag=dnd.projector,tag=dnd.genetic_extractor] if data storage dnd:storage root.temp.item[{Slot:1b}].Count unless data storage dnd:storage root.temp.item[{Slot:6b}].Count run item replace block ~ ~ ~ container.6 from block ~ ~ ~ container.1
execute if entity @s[tag=!dnd.projector,tag=!dnd.genetic_extractor,scores={dnd.dummy=1}] run item replace block ~ ~ ~ container.1 with air
## If item in slot where it shouldn't be then empty it
execute unless entity @s[tag=dnd.genetic_extractor,scores={dnd.dummy=1}] unless entity @s[tag=dnd.projector,scores={dnd.dummy=1}] if data storage dnd:storage root.temp.item[{Slot:0b}].Count unless entity @s[tag=dnd.slot0] run function dnd:block/global/gui/empty_slot/slot0
execute unless entity @s[tag=!dnd.genetic_extractor,tag=!dnd.projector,scores={dnd.dummy=1}] if data storage dnd:storage root.temp.item[{Slot:1b}].Count unless entity @s[tag=dnd.slot1] run function dnd:block/global/gui/empty_slot/slot1
