...
execute if score temp_0 dnd.dummy matches 1.. run loot spawn ~ ~ ~ loot dnd:items/genetic_extractor
particle minecraft:item furnace{CustomModelData:400002} ~ ~ ~ 0.2 0.2 0.2 0.05 50 normal
